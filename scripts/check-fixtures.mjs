...
const mapList = readFixture('maps/map_list.json');
assertObject(mapList, 'fixtures/maps/map_list.json');
assertObject(mapList.data, 'fixtures/maps/map_list.json.data');
if (!Array.isArray(mapList.data.items)) {
  throw new Error('fixtures/maps/map_list.json.data.items must be an array');
}
